...
export const CustomModuleApplyAllModal: React.FC<CustomModuleApplyAllModalProps> = ({ 
    isOpen, onClose, onApply, profiles, moduleApiName, availableFields, initialData, service
}) => {
  ...
  // 🚨 FIX: Removed initialData and availableFields from dependencies so it doesn't wipe when typing!

...
export const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose, onSave, profile, socket }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 🚨 FIX: We only strictly require the Profile Name now.
    ...
    // 🚨 FIX: If they don't have a Webhook URL AND they don't have Zoho Creds, block them.
    // BUT if they have a Webhook URL, let them save immediately without Zoho Creds!

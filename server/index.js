...
io.on('connection', (socket) => {
    ...
    // ==========================================
    // 🧹 BULLETPROOF CLEAR CONTROLLER (Protects Flow)
    // ==========================================
...
server.listen(port, () => {
    console.log(`🚀 Distributed Web API Server is running on http://localhost:${port}`);
});